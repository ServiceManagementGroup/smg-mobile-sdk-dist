...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "SMGSurveyKit",
            url: "https://github.com/ServiceManagementGroup/smg-mobile-sdk-dist/releases/download/0.4.0/SMGSurveyKit.xcframework.zip",
            checksum: "76d3def225326453047ad7db3c6a2e084c477544ab53d2918f3729c1775bb41b"
        )
    ]
)
